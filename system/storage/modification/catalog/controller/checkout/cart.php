		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['success'] = '<img class="prod_image" src="' . $image . '"><div>' . 
									...
									'<div><a href="' . $this->url->link('checkout/cart') . '"><i class="fa fa-shopping-cart"></i> ' . $this->language->get('text_cart') . '</a>&nbsp;&nbsp; ' . '<a href="' . $this->url->
			link('checkout/nicocheckout') . '"><i class="fa fa-share"></i> '. $this->language->get('text_checkout') . '</a></div></div>';
