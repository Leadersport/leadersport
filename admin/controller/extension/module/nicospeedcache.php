...
class ControllerModuleNicoSpeedCache extends NicoModule 
{
    ...
    public function index($success = '') {
		...
		if ($opencart_version >= 2300 && $success == '') //calling other methods than index in oc 2.3.x is broken :(
		{
	...
	{   
        ...
        if (!($this->user->hasPermission('modify', 'module/nicospeedcache') || $this->user->hasPermission('modify', 'extension/module/nicospeedcache'))) {
