             ...
             <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left" style="width: 40%;"><?php foreach ($languages as $language) { ?>
                  <div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>
                    <textarea name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][title]" placeholder="<?php echo $entry_title; ?>" class="form-control banner-image-description input-description<?php echo $language['language_id'] .'-' .$image_row; ?>" rows=10 ><?php echo isset($banner_image['banner_image_description'][$language['language_id']]['title']) ? $banner_image['banner_image_description'][$language['language_id']]['title'] : ''; ?></textarea>
                  </div>
...
$('#images').on('focus', '.banner-image-description', function(){
...
function addImage() {
  ...
  html += '  <td class="text-left" style="width: 40%;">';
	...
	html += '      <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><textarea type="text" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][title]" placeholder="<?php echo $entry_title; ?>" class="form-control banner-image-description input-description<?php echo $language['language_id']; ?>-' + image_row + '" rows=10 /></textarea>';
  html += '    </div>';
	html += '  </td>';	
	html += '  <td class="text-left" style="width: 20%;"><input type="text" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';	
