...
{
	global $theme_name, $_clear_speed_cache, $_clear_opencart_cache, $_success, $opencart_version;
	...
	if (!_nico_is_speed_cache()) 
	{
		...
		<a class="btn btn-primary btn-lg button" href="?route=<?php echo $extension_path;?>nicospeedcache/install_speed_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>"><i class="fa fa-wrench"></i>&ensp;Install speed cache</a>
	...
	<a href="?route=<?php echo $extension_path;?>nicospeedcache/clear_speed_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>" class="btn btn-primary button" name="clear_speed_cache" value="clear_speed_cache"><i class="fa fa-refresh"></i>&ensp;Clear speed cache</a>
	<a href="?route=<?php echo $extension_path;?>nicospeedcache/clear_opencart_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>" class="btn btn-default btn-secondary button" name="clear_speed_cache" value="clear_speed_cache"><i class="fa fa-recycle"></i>&ensp;Clear opencart cache</a>
	<a href="?route=<?php echo $extension_path;?>nicospeedcache/clear_javascript_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>" class="btn btn-default btn-secondary button" name="clear_speed_cache" value="clear_speed_cache"><i class="fa fa-recycle"></i>&ensp;Clear javascript cache</a>
	<a href="?route=<?php echo $extension_path;?>nicospeedcache/clear_css_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>" class="btn btn-default btn-secondary button" name="clear_speed_cache" value="clear_speed_cache"><i class="fa fa-recycle"></i>&ensp;Clear css cache</a>
	<br/>
	<br/>
	<div class="alert alert-info" role="alert">
	...
	<hr/>
	<a class="btn btn-danger button" href="?route=<?php echo $extension_path;?>nicospeedcache/uninstall_speed_cache&token=<?php if (isset($_GET['token'])) echo $_GET['token'];?>&user_token=<?php if (isset($_GET['user_token'])) echo $_GET['user_token'];?>"><i class="fa fa-trash"></i>&ensp; Uninstall speed cache</a><span></span>
	<?php
}
?>
<style>
