...
if (isset($categories)) $categs = $categories;
	...
	<div class="nico_menu">
			...
			<li <?php if (isset($category['categories'])){?> class="categories"<?php }?>>
				<a href="">
					...
					<input type="text" _name="text" _code="<?php echo $language['code'];?>" size="10" class="<?php if ($first) {echo 'first';$first=false;}?> form-control"
					 value="<?php if (isset($category['text'][$language['code']])) echo $category['text'][$language['code']]; ?>" />
					<?php }  ?>
					</div>
					
				
					<label>Url</label> <input type="text" _name="url" size="20" class="form-control"
					 value="<?php if (isset($category['url'])) echo $category['url'];?>"/>							 

					</div>
					<div class="col-md-3">
					Target
					<select _name="target" class="form-control">
					...
					Full width
					<select _name="full_width" class="form-control">
					...
					<span class="columns">
					Columns
					<select _name="columns" class="form-control">
					...
					Highlight
					<select _name="highlight" class="form-control">
					...
					<input type="text" _name="font_icon" size="20" class="form-control"
					 value="<?php if (isset($category['font_icon'])) echo $category['font_icon'];?>"/>							 

					Type
					<select _name="menu_type" class="menu_type form-control" >
					...
					<?php if ($opencart_version < 2000) {?>
						<input type="text" _name="product" value="" autocomplete="off" class="form-control"/>
						<div class="scrollbox">
								<?php $class = 'odd'; ?>
						...
						<input type="hidden" _name="autocomplete"  class="form-control"
					...
					<div class="menu_section category" <?php if (isset($category['menu_type']) && $category['menu_type'] !='category') {?>style="display:none"<?php }?>>
					    Categories
					    <select class="categories form-control" _name="category">
					    <option value="0">All categories</option>
					      <?php if ($categs && is_array($categs)) foreach($categs as $id => $catname) {?>
					...
					<div class="menu_section category_products"  <?php if (isset($category['menu_type']) && $category['menu_type'] !='category_products') {?>style="display:none"<?php }?>>
						Sources
						<select class="categories form-control" _name="products_category">
						...
						<option value="0">All categories</option>
						  <?php if ($categs && is_array($categs)) foreach($categs as $id => $_name) {?>
						...
						Limit
						<input type="text" _name="products_category_limit"  class="form-control"
					...
					Manufacturer order
					<select class="manufacuter_order form-control" _name="manufacuter_sort">
...
<div class="nico_new_menu_item_template" style="display:none">
     <div>
		...
		<?php if ($opencart_version < 2000) {?>
				<input type="text" _name="product" value="" class="form-control">
...
$('.nico_menu').delegate('select.menu_type', 'change', function() 
{
    ...
    jQuery('> div .html_editor', parent)
     .ckeditor({
	    filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>',
	    filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>',
	    filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>',
	    filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>',
	    filebrowserImageUploadUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>',
	    filebrowserFlashUploadUrl: 'index.php?route=common/filemanager&token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>&user_token=<?php if (isset($token)) echo $token;else if (isset($user_token)) echo $user_token; ?>'
    }).resize( '100%', '250' );
    <?php } ?>
});
...
jQuery(document.body).on("click", "a.nico_add_menu_item",function(e) 
{
	...
	//newnode = ref.create_node("#", "Menu item", "last", null, true);
