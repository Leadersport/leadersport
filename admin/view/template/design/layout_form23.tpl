        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="row">
			  ...
			  <?php 
              $theme_config = glob(dirname($_SERVER['SCRIPT_FILENAME']) . '/../catalog/view/theme/*/theme_config.inc');
              if ($theme_config) $theme_config_file = $theme_config[0];
              if (isset($theme_config_file) && $theme_config_file) include($theme_config_file);
