...
<ul class="menu-account" id="menu-account">
  <?php if (!$logged) { ?>
 <li><a href="<?php echo $login; ?>" class="list-group-item"><?php echo $text_login; ?></a></li> <a href="<?php echo $register; ?>" class="list-group-item"><?php echo $text_register; ?></a></li> <a href="<?php echo $forgotten; ?>" class="list-group-item"><?php echo $text_forgotten; ?></a></li>
  <?php } ?>
  <li> <a href="<?php echo $account; ?>" class="list-group-item"><?php echo $text_account; ?></a></li>
  <?php if ($logged) { ?>
   <li><a href="<?php echo $edit; ?>" class="list-group-item"><?php echo $text_edit; ?></a></li> <a href="<?php echo $password; ?>" class="list-group-item"><?php echo $text_password; ?></a></li>
  <?php } ?>
 ...
 <!--<?php if (isset($text_reward)) {?><a href="<?php echo $reward; ?>" class="list-group-item"><?php echo $text_reward; ?></a></li>-->
  <?php } ?> 
