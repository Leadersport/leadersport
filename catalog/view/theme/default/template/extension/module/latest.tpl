...
<div class="text-popular">Популярные продукты</div>
<div class="text1-popular">В результате сгенерированный</div>
<div class="readmore-popular"><a href="popular">Подробнее</a></div>
</div>
  <?php foreach ($products as $product) { ?>
  <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12 prod prod-popular">
  <div class="product">
