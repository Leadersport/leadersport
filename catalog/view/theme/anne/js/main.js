...
//		console.log(jQuery(this).parents("#product"));
	...
	$(document).on("mouseenter", "#cart.dropdown-toggle",function(e)
	{
	 ...
	 $(".header .navbar input.search-query1").searchautocomplete("/index.php?route=product/search&ajax&filter_name=");
	...
	$('.navbar-search button.icon-search').on('click', function(e) {
		...
		var search = $('.navbar-search input.search-query1').prop('value');
