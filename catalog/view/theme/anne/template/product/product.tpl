...
<div class="container modificate cartochka-tovara"  vocab="http://rdf.data-vocabulary.org/#">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> prod-cart"><?php echo $content_top; ?>
      <div class="row product-info" itemscope itemtype="http://data-vocabulary.org/Product">
		...
		<p>
		  ...
		  <a href="" onclick="$('a[href=\'#tab-review\']').trigger('click');$('html, body').animate({scrollTop: $('#tab-review').offset().top}, 2000);return false;"><?php echo $reviews; ?></a>
		  <!--<a href="" onclick="$('a[href=\'#tab-review\']').trigger('click');$('html, body').animate({scrollTop: $('#tab-review').offset().top}, 2000);return false;"><?php echo $text_write; ?></a>-->
		  </span>
		</p>
...
<div>
		...
		<div class="col-md-12 col-sm-12 product-option1">
            <div class="form-group prod-pult">
          ...
          if ($price) { ?>
          <ul class="list-unstyled price-block" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
            <?php if (!$special) { ?>
            <li>
			  ...
			  <?php }?>              <h2 class="price" itemprop="price" <?php if ($price_change_quantity != 1) {?>data-price="<?php  echo $__price;?>" data-currency="<?php echo $_config->get('config_currency');?>"<?php }?>> 
  			    <?php 
					echo $__price;
				?>
			  </h2>
            ...
            <?php } else { ?>
            <li>
              <h2 class="price" itemprop="price" price="<?php echo $special;?>"><?php echo $special; ?></h2> <h2 class="price strike"><?php echo $price; ?></h2>
            </li>
            <?php } ?>
            <?php if ($tax) { ?>
          ...
          <?php } ?>		
           ...
           <button type="button" id="button-cart" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" class="btn btn-primary button-cart"><span class="mini-cart-prod"></span><?php echo $button_cart; ?></button>
	 ...
	 <div class="product_wish_compare">
		<button type="button" data-toggle="tooltip" class="btn btn-default" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><span class="prod-whishlist"></span> <?php echo $button_wishlist; ?></button>
		<button type="button" data-toggle="tooltip" class="btn btn-default" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><prod class="prod-compare"></prod> <?php echo $button_compare; ?></button>
	  </div>	   
        ...
        <div class="<?php echo $class; ?> col-sm-12 product-image">
          ...
          <?php if ($thumb || $images) { ?>
            ...
            <?php if ($thumb) { ?>
			<div class="col-md-9 image-prod">
            <div class="image"><a class="cloud-zoom image-popup-zoom" id="zoom1" data-zoom="adjustX:0, adjustY:0" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $popup; ?>" itemprop="image" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></div>
            </div>
			<?php } ?>
			
            <?php if ($images) { ?>
			<div class="col-md-3 gallery-prod">
	       <div class="image-additional">
				<ul class="slides">    
				<?php foreach ($images as $image) { ?>
				<li>
					<a class="cloud-zoom-gallery item <?php if (strpos($image['popup'], 'http') !== false) echo '/*mfp-iframe*/';?>"  href="<?php echo $image['popup']; ?>" data-zoom="useZoom:zoom1, smallImage:<?php echo $image['popup']; ?>" title=""><img src="<?php echo $image['thumb']; ?>" title="" alt="" /><img src="<?php echo $image['popup']; ?>" title="" alt="" class="popup" /></a>
				</li>
				<?php } if ($show_main_image_thumb != 1) {?>
				<li>
					<a class="cloud-zoom-gallery item <?php if (strpos($popup, 'http') !== false) echo 'mfp-iframe';?>"  href="<?php echo $popup; ?>" data-zoom="useZoom:zoom1, smallImage:<?php echo $popup; ?>" title=""> <img src="<?php echo $popup; ?>" title="" alt="" /></a>
				</li>
				<?php }?>
				</ul>
			</div>
	  ...
	  <div class="tabs tabs_product">
	    ...
	    <?php echo $tabs;?>
          ...
          <div class="tab-content">
			...
			<div class="all-review">Характеристики</div>
              <table class="table specefication">
            ...
            <div class="tab-pane" id="tab-review">
              <form class="form-horizontal" id="form-review">
                ...
                <div class="form-group required">
                  <label class="col-sm-12 control-label" for="input-review"><?php echo $entry_review; ?></label>
                  <div class="col-sm-12">
                ...
                <div class="form-group required">
													<div class="col-sm-12">
														<label class="control-label entry-rating"><?php echo $entry_rating; ?></label>
      ...
      <div class="row">
        <?php $i = 0; ?>
        <?php if ($column_left && $column_right) { ?>
        <?php $cols = 'col-lg-6 col-md-6 col-sm-12 col-xs-12 prod'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $cols = 'col-lg-4 col-md-4 col-sm-6 col-xs-12 prod'; ?>
        <?php } else { ?>
        <?php $cols = 'col-lg-3 col-md-3 col-sm-6 col-xs-12 prod'; ?>
        <?php } ?>
