...
<div class="container modificate">
  ...
  <?php } ?>
  <div class="row compare"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
            <a href="<?php echo $product['remove']; ?>" class="btn btn-primary btn-block"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      <?php } else { ?>
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn-primary"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>
