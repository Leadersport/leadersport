		    ...
		    <div class="container">
				<div class="container-row">
					...
					<div class="message-slide">
						<?php if (isset($slide['title']) && !empty($slide['title'])) {?><h3 class="title in-from-left fast"><?php echo html_entity_decode($slide['title']); ?></h3><?php }?>
						<?php if (isset($slide['subtitle']) && !empty($slide['subtitle'])) {?><h2 class="title in-from-right fast"><?php echo html_entity_decode($slide['subtitle']); ?></h2><?php }?>
