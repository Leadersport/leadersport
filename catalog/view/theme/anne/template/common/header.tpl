...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<?php 
		...
		{?><link href='//fonts.googleapis.com/css?family=<?php if ($google_fonts = nico_get_config('google_fonts')) echo  str_replace('|','%7C',$google_fonts);else echo str_replace('|','%7C','Montserrat|Open+Sans:300,400,600|Lato:300,400,600,700|Varela Round|Great+Vibes|Vidaloka');?>' rel='stylesheet' type='text/css'/><?php }  
		...
		$is_css_file_writable = is_readable(DIR_TEMPLATE . $theme_directory . '/css/editor_settings.css') && is_writable(DIR_TEMPLATE . $theme_directory . '/css/editor_settings.css');
		if ($is_css_file_writable)
		$_nico_head_style ['common'][] = 'catalog/view/theme/' .$theme_directory. '/css/editor_settings.css';
		else
		...
		<?php echo $analytic; ?>
		<?php } ?>
<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700|Oswald:300,400,500,600,700|Poppins:300,400,500,600,700&amp;subset=cyrillic" rel="stylesheet">
