...
//$_config =  $this->registry->get('config');
?>
	<div class="cart-head cart">
	
	 <span class="cart-total-head"><?php echo $text_items;?></span>
		<a id="cart" href="<?php echo $cart;?>" class="dropdown-toggle" data-toggle="dropdown" role="button"><span class="cart-icon"></span>
			...
			<div class="shopping-cart-header">
					...
					<h5 class="cart-title">Корзина</span></h5>
				...
				<tr>
				  ...
				  <div class="cart-info1"><?php echo $product['quantity']; ?> x <span><?php echo $product['total']; ?></span></div>
				...
				<div class="cart-total">
					<table class="table">
					  ...
					  <tr>
						...
						<td class="text-right cart-price"><?php echo $total['text']; ?></td>
					  </tr>
					  <?php } ?>
					
					</table>
					<div class="text-center button-mini-cart"><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a>
							
							<!--<a href="<?php if (nico_get_config('checkout')  == '1') echo str_replace('/checkout', '/nicocheckout', $checkout); else echo $checkout; ?>"><i class="fa fa-share"></i>&nbsp;<?php echo $text_checkout; ?></a>-->
