		...
		<form action="/" class="navbar-form navbar-search navbar-right">
		  <div class="input-group"> 
			...
			<div class="search-100">
			  <?php if (isset($search)) {?>
			  <input type="text" name="search" class="search-query1 col-xs-4" autocomplete="off" placeholder="<?php if (isset($text_search)) echo $text_search; ?>" value="<?php if (isset($search)) echo $search; ?>" />
			  <?php } else {?>
