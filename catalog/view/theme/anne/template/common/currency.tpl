...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="currency">
  <div class="btn-group">
    ...
    <ul class="dropdown-menu pull-right">
      ...
      <li><a href="#<?php echo $currency['code']; ?>" title="<?php echo $currency['title']; ?>" onclick=" $('input[name=\'currency_code\'],input[name=\'code\']').attr('value', '<?php echo $currency['code']; ?>');$('input[name=\'redirect\']').attr('value', '<?php echo $redirect; ?>&code=<?php echo $currency['code']; ?>');$('#currency').submit();return false;"><?php echo $currency['symbol_left']; ?> <?php echo $currency['title']; ?></a></li>
      <?php } else { ?>
      <li><a href="#<?php echo $currency['code']; ?>" title="<?php echo $currency['title']; ?>" onclick=" $('input[name=\'currency_code\'],input[name=\'code\']').attr('value', '<?php echo $currency['code']; ?>');$('input[name=\'redirect\']').attr('value', '<?php echo $redirect; ?>&code=<?php echo $currency['code']; ?>');$('#currency').submit();return false;"><?php echo $currency['symbol_right']; ?> <?php echo $currency['title']; ?></a></li>
      <?php } ?>
      <?php } ?>
    </ul>
  </div>
