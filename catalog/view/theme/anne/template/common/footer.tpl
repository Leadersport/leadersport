...
var twitter_footer_interval = setInterval(function ()
{
	...
	if (height > {$twitter_height})
	{
		jQuery("#social_twitter .twitter-timeline").height({$twitter_height});
		if (height = jQuery("#social_twitter .twitter-timeline").height() <= {$twitter_height})	clearInterval(twitter_footer_interval);
	}
}, 1000);*/
FJS;
...
<?php 
$footer_top = nico_get_modules('below_content');
	...
	<div class="container">
		...
		if ($footer_about_text) { ?>
		 ...
		 <?php } ?>
		  ...
		  <div class="col-md-2 col-sm-3 social">
				...
				<ul class="social-network">
					...
					<?php } ?>
					<li><a href="vk.com"><i class="fa fa-vk"></i></a></li>
				...
				<div class="pay-cc">
				<div class="pay">Payment Methods:</div>
				<img class="footer-cc" src="catalog/view/theme/<?php echo $theme_directory;?>/img/cc1.png">
				</div>
			</div>
   </div>	
</div>
...
$.each($("#menu-account li a"),function(){
