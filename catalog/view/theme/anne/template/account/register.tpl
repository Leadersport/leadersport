...
<div class="container modificate">
  ...
  <div class="row page-account"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?>">    <div class="display-none"><?php echo $content_top; ?></div>
      <h1><?php echo $heading_title; ?></h1>
      <p class="text-opisanie"><?php echo $text_account_already; ?></p>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<?php if (isset($text_your_address)) {?>
        <fieldset>
