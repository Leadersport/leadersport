      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <div class="input-group date"><input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-format="YYYY-MM-DD" id="input-date-ordered" class="form-control" />
        ...
        <fieldset>
          ...
          <div class="form-group">
			...
			<?php if (isset($captcha)) echo $captcha; //oc 2.1.x
			else 
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            <?php } ?>
            <input type="submit" value="<?php if (isset($button_continue)) echo $button_continue;else echo $button_submit; ?>" class="btn btn-primary" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons clearfix">
          ...
          <div class="pull-right">
            <input type="submit" value="<?php if (isset($button_continue)) echo $button_continue;else if (isset($button_submit)) echo $button_submit;?>" class="btn btn-primary" />
          </div>
        </div>
        <?php } ?>
      </form>
...
<!-- link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php //echo $theme_name;?>/css/bootstrap-datetimepicker.min.css">
<script src="catalog/view/theme/<?php //echo $theme_name;?>/js/moment.js"></script>
<script src="catalog/view/theme/<?php //echo $theme_name;?>/js/bootstrap-datetimepicker.min.js"></script -->
