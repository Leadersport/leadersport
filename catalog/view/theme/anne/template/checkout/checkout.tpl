  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel-group" id="accordion">
        ...
        <?php if (!$logged && (isset($account) && $account != 'guest')) { ?>
        <div class="panel panel-default">
          <div class="panel-heading">
...
$(document).delegate('#button-login', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/login/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-register', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/register/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-payment-address', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/payment_address/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-shipping-address', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/shipping_address/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-guest', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/guest/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-guest-shipping', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/guest_shipping/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
        data: $('#collapse-shipping-address input[type=\'text\'], #collapse-shipping-address input[type=\'date\'], #collapse-shipping-address input[type=\'datetime-local\'], #collapse-shipping-address input[type=\'time\'], #collapse-shipping-address input[type=\'password\'], #collapse-shipping-address input[type=\'checkbox\']:checked, #collapse-shipping-address input[type=\'radio\']:checked, #collapse-shipping-address textarea, #collapse-shipping-address select'),
        dataType: 'json',
        beforeSend: function() {
...
$(document).delegate('#button-shipping-method', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/shipping_method/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>',
        type: 'post',
...
$(document).delegate('#button-payment-method', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/payment_method/<?php if (isset($account)) {?>save<?php } else {?>validate<?php } ?>', 
        type: 'post',
