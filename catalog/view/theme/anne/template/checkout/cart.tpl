...
<div class="container modificate" id="container">
  ...
  <?php } ?>
  <div class="row cart-page"><?php echo $column_left; ?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-primary1"><i class="fa fa-refresh"></i></button>
