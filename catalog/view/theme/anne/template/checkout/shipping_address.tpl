<form class="form-horizontal">
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <?php if (isset($custom_fields) && is_array($custom_fields)) foreach ($custom_fields as $custom_field) { ?>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" class="btn btn-primary" />
    </div>
  </div>
</form>
